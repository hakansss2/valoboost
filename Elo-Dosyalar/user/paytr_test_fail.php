        ...
        <div class="col-lg-8">
            <div class="card shadow-sm border-0">
                <div class="card-body p-5 text-center">
                    ...
                    <h2 class="mb-3">Test Ödemesi Başarısız</h2>
                    <p class="text-muted mb-4">Test ödemesi tamamlanamadı.</p>
                    
                    <div class="alert alert-info">
                        <h5><i class="fas fa-info-circle"></i> Test Bilgileri</h5>
                        <p>Bu sayfa PayTR test ödemesi başarısız olduğunda gösterilir.</p>
